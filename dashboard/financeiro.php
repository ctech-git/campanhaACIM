          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="product-payment-inner-st">
              <ul id="myTabedu1" class="tab-review-design">
                <li><a href="#description">Caixa do Cambista</a></li>
                <li><a href="#relatorioAlternativo">Relatório Alternativo</a></li>
                <li><a href="#information">Relatórios</a></li>
                <li><a href="#supervisor">Supervisor</a></li>
                <li class="active"><a href="#todososRelatorios">Todos os relatórios</a></li>
                <li><a href="#despesa_supervisor">Despesa Gerente</a></li>
                <li><a href="#graficoGerente">Gerente</a></li>
              </ul>
              <div id="myTabContent" class="tab-content custom-product-edit">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group ">
                                  ...
                                  <input oninput="this.value = this.value.toUpperCase()" required name="descricao"
                                    autocomplete="off" id="descricao" type="text" class="form-control"
                                ...
                                <div class="form-group ">
                                  ...
                                  <input required name="descricao" autocomplete="off" id="comissaoCambista"
                                    type="number" class="form-control" placeholder="Em porcentagem. Ex: 15">
                                </div>

                                <div class="form-group">
                                  <label>Data Inicial</label>
                                  <input required name="data" id="data_inicial" type="date" class="form-control"
                                    placeholder="Nome da Gerência">
                                </div>
                                <div class="form-group">
                                  <label>Data Final</label>
                                  <input required name="data" id="data_final" type="date" class="form-control"
                                    placeholder="Nome da Gerência">
                                  <input type='hidden' required name="token" id="token" type="date" class="form-control"
                                    placeholder="Nome da Gerência">
                                </div>
                ...
                <div class="product-tab-list tab-pane fade active  in" id="todososRelatorios">
                                ...
                                <div class="row">
                                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="sparkline13-list">
                                      <div class="sparkline13-hd">
                                        <div class="main-sparkline13-hd">
                                          <h1>Tabela de Relatórios enviados</h1>
                                        </div>
                                      </div>

                                      <div class="sparkline13-graph">
                                        <div class="datatable-dashv1-list custom-datatable-overright">
                                          <table style='width:100%' id='tabela_dados_relatorios'
              ...
              <div class="product-tab-list tab-pane fade  in" id="graficoGerente">
                              ...
                              <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                  <div class="sparkline13-list">
                                    ...
                                    <div class="sparkline13-graph">
                                      <div class="datatable-dashv1-list custom-datatable-overright">
                                        <table style='width:100%' id='tabela_gerentes' class='display compact'>
                                          <thead>
                                            <tr>
                                              <th>Supervisor</th>
                                              <!-- <th>Gerência</th> -->
