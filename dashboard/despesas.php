                          ...
                          <form class="dropzone dropzone-custom needsclick add-professors" id="myForm1">
                            <div class="row">
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                  <input name="categoria" oninput="this.value = this.value.toUpperCase()" autocomplete="off" id="valor" type="text"  class="form-control" placeholder="Valor (exemplo: R$ 45,00)">
                                </div>
                            ...
                            if (mysqli_num_rows($result) > 0) {
                              while($row = $result->fetch_array(MYSQLI_ASSOC)){
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $soma ?></td>
                                  <td><button class='btn btn-primary' onclick='ver_historico_despesa("<?php echo $gerencia ?>","<?php echo $cambista ?>")'>Histórico</button></td>
                                </tr>
                                <?php
                              }
                            }
