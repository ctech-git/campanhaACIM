...
<head>
  ...
  <title>Futuro Educacional</title>
...
<body>
  ...
  <div class="all-content-wrapper">
    ...
    <div class="header-advance-area">
      ...
      <!-- Mobile Menu start -->
      <?php require_once('menu_mobile.html') ?>
      <!-- Mobile Menu end -->
    ...
    <div class="library-book-area mg-t-30">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="single-cards-item">
              ...
              <div class="single-product-text">
                <img src="img/product/pro4.jpg" alt="">
                <h4 id="nome_estudante"><a class="cards-hd-dn" href="#">Angela Dominic</a></h4>
                <h5 id="data_nascimento">Web Designer & Developer</h5>
                <p class="ctn-cards" id="informacoes_pais">Lorem ipsum dolor sit amet, this is a consectetur adipisicing elit</p>
                <a class="follow-cards" href="#">Follow</a>
                <div class="row">
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <div class="cards-dtn">
                      <h3 id="frequencia_global"><span class="counter">199</span></h3>
                      <p>Frequência</p>
                    </div>
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <div class="cards-dtn">
                      <h3 id="materias_cadastradas"><span class="counter">599</span></h3>
                      <p>Matérias Feitas</p>
                    </div>
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <div class="cards-dtn">
                      <h3 id="situacao_aluno"><span class="counter">399</span></h3>
                      <p>Situação</p>
                    </div>
                  </div>
                </div>
          ...
          <link href="https://fonts.googleapis.com/css?family=KoHo:200,300,400,500,600,700,900" rel="stylesheet"><link rel="stylesheet" href="./style_graphs.css">
    ...
    <div class="analytics-sparkle-area" style="margin-top:3%">
      <div class="container-fluid">
        <div class="row">
...
$( document ).ready(function() {
  ...
  //     informacoes= JSON.parse(data);
  //     console.log(informacoes);
  //     document.getElementById("nome_estudante").innerHTML = informacoes.data.pessoa.nome;
  //     var anos = calculaIdade(informacoes.data.pessoa.dataNascimento);
  //     document.getElementById("data_nascimento").innerHTML = anos+ " anos";
  //     if(informacoes.data.pessoa.sexo=="M")  document.getElementById("informacoes_pais").innerHTML = "Filho de <a href='tel:"+informacoes.data.pessoa.relacoes[0].pessoa.telefones[0].numero+"'>" +informacoes.data.pessoa.relacoes[0].pessoa.nome + "</a>  e <a href='tel:"+informacoes.data.pessoa.relacoes[0].pessoa.telefones[0].numero+"'>" + informacoes.data.pessoa.relacoes[1].pessoa.nome+"</a>";
  //
  //     if(informacoes.data.pessoa.sexo=="F")  document.getElementById("informacoes_pais").innerHTML = "Filha de "+informacoes.data.pessoa.relacoes[0].pessoa.nome + " e "+ informacoes.data.pessoa.relacoes[1].pessoa.nome;
  //   }
  // });
  //
  // $.ajax({
  //   url: "Control/todas_as_turmas.php",
  //   type: "GET",
  //   async:false,
  //   data: {
  //     id:id
  ...
  //     console.log(dados);
  //
  //     document.getElementById("frequencia_global").innerHTML = dados.data.matriculas.nodes[0].boletim.frequenciaGlobal + "%";
  //     document.getElementById("materias_cadastradas").innerHTML = dados.data.matriculas.nodes[0].boletim.registros.length;
  //     document.getElementById("situacao_aluno").innerHTML = dados.data.matriculas.nodes[0].situacao;
  //   }
  // });
...
function calculaIdade(nascimento){
  var d = new Date();
  var hoje = new Date (d.getFullYear() + "/" + d.getMonth() + "/" + d.getDate());
  nascimento = nascimento.replace('-','/');
  nascimento = new Date(nascimento);

  if(nascimento.getMonth() == hoje.getMonth()){
    alert("Aniversário esse mês");
...
async function buscar_matricula(){
  const { value: matricula } = await Swal.fire({
    title: 'Qual sua matrícula?',
    input: 'number',
    imageUrl: 'http://www.futuroeducacional.com/wp-content/uploads/LOGO-FUTURO-EDUCACIONAL.png',
    imageHeight: 100,
  ...
  if (matricula) {
    ...
    wrapper.innerHTML = '<iframe name="fotos" align="left" frameborder="0" style="height:50vh; width: 100% !important;" scrolling="auto" src="estrelas.html" >';
    var a =0;
    const { value: resposta } = await  Swal.fire({
      title: 'Como você está começando o dia hoje?',
      //text: texto,
