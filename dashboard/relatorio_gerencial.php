          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="product-payment-inner-st">
              <ul id="myTabedu1" class="tab-review-design">
                <li ><a href="#description">Adicionar Despesa</a></li>
                            ...
                            <div class="row">
                              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <input  required name="categoria" autocomplete="off" id="supervisor" type="text" class="form-control" placeholder="Supervisor ">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <input name="categoria"  autocomplete="off" id="caixa" type="text"  class="form-control produto_em_reais" placeholder="Caixa">
                                </div>

                                <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12" style='padding:0 !important'>
                                  <span><label>Comissão (%)</label></span>
                                  <input name="categoria"  autocomplete="off" onblur='calcular_comissao()' id="comissao" type="text"  class="form-control" placeholder="Comissão (%)">
                                </div>
                                <div class="form-group  col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                  <span><label>Valor da comissão</label></span>
                                  <input name="categoria" disabled  autocomplete="off" id="data_inicial" type="text"  class="form-control produto_em_reais" placeholder="Valor da Comissão">
                                </div>

                                <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12" style='padding:0 !important'>
                                  <span><label>Período Inicial</label></span>
                                  <input name="categoria"  autocomplete="off"  id="data_final" type="date"  class="form-control" placeholder="Comissão (%)">
                                </div>
                                <div class="form-group  col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                  <span><label>Período Final</label></span>
                                  <input name="categoria"  autocomplete="off" id="text_valor_comissao" type="date"  class="form-control produto_em_reais" placeholder="Valor da Comissão">
                                </div>
                                <!-- <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input name="categoria"  autocomplete="off" id="ajuda_custo" type="text"  class="form-control produto_em_reais" placeholder="Ajuda de custo">
                              </div>
                              ...
                              <div id='outras_entradas'>
                                <div class='row' style='margin-top:40px'>
                                  <div class="col-6 col-sm-6 col-md-6">
                                    ...
                                    <select style='font-size:12px' name='id_outras_entradas' class="form-control texto_itens_carrinho" id="id_outras_entradas">
                                  ...
                                  <div style='' id='div_valor_desconto' class=" col-6 col-sm-6 col-md-6">
                                    ...
                                    <input name="valor_movimentado" required autocomplete='off' id="valor_movimentado" type="text"  inputmode='numeric' class="form-control produto_em_reais">
                                  </div>
                                </div>
                                ...
                                <div class='row' style='margin-bottom:30px; padding:0px'>
                                  <div class="col-12 col-sm-12 col-md-12" style='padding:0px'>
                                    ...
                                    <div class="col-sm-12">
                                      <input name="observacoes" id="observacoes" placeholder="" type="text" class="form-control texto_itens_carrinho"></div>
                                    </div>
                                  </div>
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              <div class="payment-adress">
                                <button type="button" onclick="salvar_form_relatorio()" id='botao_adicionar' class="btn btn-primary waves-effect waves-light">Adicionar</button>
                              </div>
                            </div>
                          </div>
                        </div>
...
$( document ).ready(function() {
  ...
  $('.produto_em_reais').mask('#.##0,00', {reverse: true});
